...
const Footer = () => {
  return (
    <footer className="bg-black text-white px-4 md:px-8 lg:px-36 py-12">
      <div className="flex flex-col md:flex-row justify-between gap-8 md:gap-0">
        <div>
          <h3 className="text-xl mb-4">Contact us</h3>
          <a href="mailto:play@melodio.ai" className="text-gray-400 hover:text-white transition-colors">
            play@melodio.ai
          </a>
        </div>
        <div>
          <h3 className="text-xl mb-4">Social contact</h3>
        ...
        <div>
          <h3 className="text-xl mb-4">Terms</h3>
